...
from clio import Stamped, Keyed, dttms, Key
from clio.process import run_command_in_shell
from clio.strs import tabulate_objects, tabulate_object, parse_readable_mem
...
def disk_usage() -> list[FileSystemUsage]:
    ...
    def parse_fs(s):
        ...
        return FileSystemUsage(now, clio_services.hostname, fs, int(sz), int(uz), int(av), m)
...
if __name__ == "__main__":
    ...
    def _main():
        ...
        shutdown = clio_services.shutdown_handler()
        i = 0
