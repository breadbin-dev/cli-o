...
from clio.dbs import sql_list
from clio.io import CaptureLogs

from clio_services.database.backup import compare_dbs
...
class DatabaseWidget:
    ...
    def backup(self, path: str = ..., secondary: bool = False):
        ...
        if answer == "OK":
            ...
            def _backup():
                ...
                audit_db = clio_services.audit_db()
    ...
    def list_backups(self, secondary: bool = False, disk: str = ...):
        ...
        if secondary and disk is ...:
            disk = clio_services.secondary_host
